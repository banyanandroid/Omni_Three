...
public class Activity_Fertility extends FragmentActivity
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: // Fragment # 0 - This will show image
                    return Fragment_16.init(position);
                case 1: // Fragment # 1 - This will show image
                    return Fragment_17.init(position);
                case 2: // Fragment # 2 - This will show image
                    return Fragment_18.init(position);
                case 3: // Fragment # 0 - This will show image
                    return Fragment_19.init(position);
